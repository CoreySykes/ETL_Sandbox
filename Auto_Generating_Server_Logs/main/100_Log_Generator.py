...
parser.add_argument("--default_file", "-df", dest="default_file", help="Use default output.log", default="no", type=str)

# Parse the Arguments
args = parser.parse_args()

# Based on arguments, add variables
...
# Creating responses for the Log Generator
